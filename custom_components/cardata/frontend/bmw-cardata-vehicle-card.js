...
const TRANSLATIONS = {
  ...
  sv: {
    location: "Plats",
    location_unavailable: "Plats okänd",
    away: "Borta",
    home: "Hemma",
    range: "Räckvidd",
    fuel: "Bränsle",
    ...
    lease_remaining: "Leasing återstående",
    monthly_budget: "Återstående/Månad",
    monthly_average: "Genomsnitt/Månad",
    km_balance: "km balans",
    driven: "Kört",
    target_today: "Dagens mål",
    total_distance: "Total kostnad",
    lease_start: "Leasing start",
    lease_end: "Leasing slut",
    projected_at_end: "Förväntat vid slut",
    cost_refund: "Kostnad / Återbäring",
    excess_km: "Övermil",
    shortfall_km: "Undermil",
    payment_due: "Ytterligare avgift",
    refund: "Återbäring",
    unit_days_short: "dag",
    unit_months_short: "mån",
    doors_overall: "Dörrar",
    lock: "Lås",
    locked: "Låst",
    unlocked: "Olåst",
    alarm: "Alarm",
    alarm_triggered: "Alarm: Utlöst",
    alarm_unavailable: "Alarm status saknas",
    windows: "Fönster",
    windows_closed: "stängd",
    windows_open_count: "öppen",
    charging_active: "aktiv",
    lights: "Belysning",
    lights_on: "på",
    lights_off: "av",
    hood_tailgate_open: "Huv och baklucka öppen",
    hood_open: "Huv öppen",
    tailgate_open: "Koffert öppen",
    hood_tailgate_closed: "Huv och baklucka stängd",
    total_range: "Total räckvidd",
    ev: "EV",
    unknown: "okänd",
    select_vehicle: "Välj ett fordon",
    vehicle_not_found: "Fordonet hittades ej. Försök igen om en stund.",
    no_tracker: "Ingen fordonsentitet hittades",
    tracker_unavailable: "Fordonsentitet otillgänglig",
    map_loading: "Laddar karta…",
    map_failed: "Kunde inte ladda Home Assistant kartan",
    "state.chargingactive": "Laddning Pågår",
    "state.chargingended": "Laddning Klar",
    "state.nocharging": "Laddar Ej",
    "state.chargingpaused": "Laddning Pausad",
    "state.chargingerror": "Laddning Fel",
    "state.doorstiltcabin": "Dörrar och Lutning",
    "state.doorsonly": "Endast Dörrar",
    "state.secured": "Säker",
    "state.open": "Öppen",
    "state.closed": "Stängd",
    "state.locked": "Låst",
    "state.unlocked": "Olåst",
    "editor.device_id": "Fordon",
    "editor.license_plate": "Registreringsnr. (Istället för VIN)",
    "editor.show_title": "Visa fordonsnamn / Kort huvud",
    "editor.soc_source": "Batteri nivå källa",
    "editor.soc_soc": "BMW Tillstånd Laddning (senaste)",
    "editor.soc_predicted": "Beräknad SOC (laddar)",
    "editor.soc_magic": "Magisk SOC (kör)",
    "editor.show_indicators": "Visa indikeringsrad",
    "editor.show_range": "Visa SOC och räckviddsbar",
    "editor.show_image": "Visa fordonsbild",
    "editor.image_crop_top": "Bildbeskäring uppe",
    "editor.image_crop_bottom": "Bildbeskäring nere",
    "editor.image_zoom": "Bild zoom",
    "editor.show_map": "Visa minikarta",
    "editor.map_height": "Minikarta höjd",
    "editor.show_buttons": "Visa snabbinfoknappar",
    "editor.leasing_entity": "Leasing sensor (frivillig)",
    "editor.leasing_tiles": "Leasing info (ordning = visningsordning)",
    "editor.language": "Kort språk",
    "editor.lang_auto": "Auto (Home Assistant språk)",
  },
  de: {
    location: "Standort",
